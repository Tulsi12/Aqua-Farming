...
#define FIREBASE_HOST "https://fishfarm-d533****************/"                          // the project name address from firebase id
#define FIREBASE_AUTH "iA1******************************"            // the secret key generated from firebase
#define WIFI_SSID "xxx" //enter your wifi id
